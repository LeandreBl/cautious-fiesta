...
{
  template <typename T>
  class PadderR : public sfs::IComponent
  {
  public:
    ...
    void display(sf::RenderWindow &window) noexcept
    {
      ...
      pos.x = window.getSize().x - _offset - _object.getGlobalBounds().width;
  ...
  template <typename T>
  class PadderL : public sfs::IComponent
  {
  public:
  ...
  template <typename T>
  class PadderT : public sfs::IComponent
  {
  public:
  ...
  template <typename T>
  class PadderB : public sfs::IComponent
  {
  public:
    ...
    {
      auto pos = _object.getPosition();
      pos.y = window.getSize().y - _offset - _object.getGlobalBounds().height;
      _object.setPosition(pos);
    }
  protected:
    T &_object;
