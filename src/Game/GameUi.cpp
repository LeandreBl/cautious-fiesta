...
namespace cf
{
    GameUi::GameUi(sfs::Scene &scene) noexcept
    {
        ...
        auto life = &addComponent<sfs::Sprite>(*scene.getAssetTexture("life.png"));
        life->setScale(sf::Vector2f(2, 1.5));
        _rectangle = &addComponent<sfs::Rectangle>(sf::Vector2f(392, 50), sf::Vector2f(0, 30), sf::Color::Black);

        auto projectile = &addComponent<sfs::Sprite>(*scene.getAssetTexture("Projectiles.png"), sf::Vector2f(300, 300));
        ...
        _life = &addComponent<sfs::Sprite>(*scene.getAssetTexture("lifeHeart.png"), sf::Vector2f(500, 500));
