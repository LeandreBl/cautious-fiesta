...
{
	auto &navbar =
		addChild<sfs::Hnavbar>(scene, sf::Vector2f(0, 0),
				       sf::Vector2f(15, 200), sf::Color::White);
...
void IpInputBox::start(sfs::Scene &scene) noexcept
{
	...
	auto &inputBox = addChild<sfs::InputBox>(
		scene, *font, sf::Vector2f(0, 0), "IP", sf::Color::White, 35);
