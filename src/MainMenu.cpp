...
namespace cf
{
  void MainMenu::start(sfs::Scene &scene) noexcept
  {
    ...
    _scroller->addChild<Layers>(scene, "assets/sprites/Nuages.jpg", sf::Vector2f(1.2, 1.2), sf::Vector2f(-150, 0));
    _scroller->addChild<Layers>(scene, "assets/sprites/trainBackground.png", sf::Vector2f(1, 1), sf::Vector2f(-300, 0), sf::Vector2f(0, 930));
    _scroller->addChild<Layers>(scene, "assets/sprites/test.png", sf::Vector2f(1, 2.5), sf::Vector2f(-250, 0), sf::Vector2f(0, 190));
    _scroller->addChild<Layers>(scene, "assets/sprites/rangéImeubles.png", sf::Vector2f(1, 1), sf::Vector2f(-325, 0), sf::Vector2f(0, 600));
    _scroller->addChild<Layers>(scene, "assets/sprites/Mimeubles.png", sf::Vector2f(1, 2.5), sf::Vector2f(-350, 0), sf::Vector2f(0, 515));
